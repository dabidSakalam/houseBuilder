...
router.get("/inquiries/:userId/details/:inquiryId", authenticateToken, (req, res, next) => {
  console.log('📝 Inquiry Details route hit! UserId:', req.params.userId, 'InquiryId:', req.params.inquiryId);
  getInquiryDetails(req, res, next);
});

// ✅ Cancel inquiry route
router.put("/inquiries/:inquiryId/cancel", authenticateToken, (req, res, next) => {
...
// ✅ Send image message
router.post("/messages/send-image", authenticateToken, upload.single('image'), (req, res, next) => {
